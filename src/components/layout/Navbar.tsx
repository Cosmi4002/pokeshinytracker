...
export function Navbar() {
  ...
  return (
    <nav
      className="sticky top-0 z-50 border-b border-border/55 bg-card/86 text-card-foreground shadow-[0_16px_42px_rgba(0,0,0,0.18)] outline outline-1 outline-black/10 backdrop-blur-2xl supports-[backdrop-filter]:bg-card/74 dark:border-white/15 dark:bg-[#171717]/88 dark:text-white dark:shadow-[0_16px_42px_rgba(0,0,0,0.3)] dark:outline-white/10 dark:supports-[backdrop-filter]:bg-[#171717]/78"
      style={{
            ...
            return (
              <Link key={link.to} to={link.to}>
                <Button
                  ...
                  size="sm"
                  className={cn(
                    'h-9 px-2 sm:px-3 gap-1.5 sm:gap-2 text-foreground outline outline-1 outline-black/5 hover:bg-muted hover:text-foreground dark:text-white dark:outline-white/10 dark:hover:bg-white/10 dark:hover:text-white',
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-[3.25rem] w-[3.25rem] rounded-xl border-2 bg-muted p-0 outline outline-1 outline-black/10 transition-all duration-300 hover:bg-muted dark:bg-white/10 dark:outline-white/15 dark:hover:bg-white/15"
                  style={{
                ...
                >
                  <span
                    className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-[0.65rem] bg-muted text-card-foreground shadow-sm dark:bg-black/20 dark:text-white"
                    style={{
