...
export const POKEBALLS = [
  { id: 'pokeball', name: 'Poké Ball', sprite: 'https://img.pokemondb.net/sprites/items/poke-ball.png' },
  { id: 'greatball', name: 'Great Ball', sprite: 'https://img.pokemondb.net/sprites/items/great-ball.png' },
  { id: 'ultraball', name: 'Ultra Ball', sprite: 'https://img.pokemondb.net/sprites/items/ultra-ball.png' },
  { id: 'masterball', name: 'Master Ball', sprite: 'https://img.pokemondb.net/sprites/items/master-ball.png' },
  { id: 'safariball', name: 'Safari Ball', sprite: 'https://img.pokemondb.net/sprites/items/safari-ball.png' },
  { id: 'sportball', name: 'Sport Ball', sprite: 'https://img.pokemondb.net/sprites/items/sport-ball.png' },
  { id: 'netball', name: 'Net Ball', sprite: 'https://img.pokemondb.net/sprites/items/net-ball.png' },
  { id: 'diveball', name: 'Dive Ball', sprite: 'https://img.pokemondb.net/sprites/items/dive-ball.png' },
  { id: 'nestball', name: 'Nest Ball', sprite: 'https://img.pokemondb.net/sprites/items/nest-ball.png' },
  { id: 'repeatball', name: 'Repeat Ball', sprite: 'https://img.pokemondb.net/sprites/items/repeat-ball.png' },
  { id: 'timerball', name: 'Timer Ball', sprite: 'https://img.pokemondb.net/sprites/items/timer-ball.png' },
  { id: 'luxuryball', name: 'Luxury Ball', sprite: 'https://img.pokemondb.net/sprites/items/luxury-ball.png' },
  { id: 'premierball', name: 'Premier Ball', sprite: 'https://img.pokemondb.net/sprites/items/premier-ball.png' },
  { id: 'duskball', name: 'Dusk Ball', sprite: 'https://img.pokemondb.net/sprites/items/dusk-ball.png' },
  { id: 'healball', name: 'Heal Ball', sprite: 'https://img.pokemondb.net/sprites/items/heal-ball.png' },
  { id: 'quickball', name: 'Quick Ball', sprite: 'https://img.pokemondb.net/sprites/items/quick-ball.png' },
  { id: 'cherishball', name: 'Cherish Ball', sprite: 'https://img.pokemondb.net/sprites/items/cherish-ball.png' },
  { id: 'fastball', name: 'Fast Ball', sprite: 'https://img.pokemondb.net/sprites/items/fast-ball.png' },
  { id: 'levelball', name: 'Level Ball', sprite: 'https://img.pokemondb.net/sprites/items/level-ball.png' },
  { id: 'lureball', name: 'Lure Ball', sprite: 'https://img.pokemondb.net/sprites/items/lure-ball.png' },
  { id: 'heavyball', name: 'Heavy Ball', sprite: 'https://img.pokemondb.net/sprites/items/heavy-ball.png' },
  { id: 'loveball', name: 'Love Ball', sprite: 'https://img.pokemondb.net/sprites/items/love-ball.png' },
  { id: 'friendball', name: 'Friend Ball', sprite: 'https://img.pokemondb.net/sprites/items/friend-ball.png' },
  { id: 'moonball', name: 'Moon Ball', sprite: 'https://img.pokemondb.net/sprites/items/moon-ball.png' },
  { id: 'beastball', name: 'Beast Ball', sprite: 'https://img.pokemondb.net/sprites/items/beast-ball.png' },
  { id: 'dreamball', name: 'Dream Ball', sprite: 'https://img.pokemondb.net/sprites/items/dream-ball.png' },
  { id: 'featherball', name: 'Feather Ball', sprite: 'https://img.pokemondb.net/sprites/items/feather-ball.png' },
  { id: 'wingball', name: 'Wing Ball', sprite: 'https://img.pokemondb.net/sprites/items/wing-ball.png' },
  { id: 'jetball', name: 'Jet Ball', sprite: 'https://img.pokemondb.net/sprites/items/jet-ball.png' },
  { id: 'leadenball', name: 'Leaden Ball', sprite: 'https://img.pokemondb.net/sprites/items/leaden-ball.png' },
  { id: 'gigatonball', name: 'Gigaton Ball', sprite: 'https://img.pokemondb.net/sprites/items/gigaton-ball.png' },
  { id: 'originball', name: 'Origin Ball', sprite: 'https://img.pokemondb.net/sprites/items/origin-ball.png' },
];
